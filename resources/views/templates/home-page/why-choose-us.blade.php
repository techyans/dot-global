<div class="row d-flex align-items-center g-5 justify-content-center">
    <div class="col-5 video-sec position-relative">
    ...
    <div class="col-7">
        <div class="content">
            ...
            <ul class="ps-3">
                ...
                <li>Our commitment to excellence is reflected in our track record of successfully.</li>
                <li>delivering over 100+ projects to satisfied clients worldwide (UI/UX to be created in a unique manner)</li>
            </ul>
        </div>
    </div>
    <div class="col-7 form-section position-relative mt-5">
        <div class="row border rounded bg-white py-3 position-absolute mt-4">
            <div class="col-6 ">
                <h3>Contact Us</h3>
