    ...
    <div class="col-7 ">
        <div class="nav-lists">
            <ul>
                ...
                <li class="top-nav-items">
                    <a href="#">Offering <i class="fa-solid fa-chevron-down"></i></a>
                ...
                <li class="top-nav-items">
                    <a href="#">Innovation <i class="fa-solid fa-chevron-down"></i></a>
                ...
                <li class="top-nav-items">
                    <a href="#">Staff Augmentation <i class="fa-solid fa-chevron-down"></i></a>
