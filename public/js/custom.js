    ...
    // Desktop nav dropdown functions=======================
    ...
    $(document).ready(function(){
        ...
        $('body').on('click','.index-page .technologies .show-more .btn',function(e){
            if($(this).hasClass('active')){
                $('.index-page .technologies .show-hide').slideUp();
                $('.index-page .technologies .show-more .btn').html('<span>View More <i class="bi bi-arrow-down ms-2 "></i></span>');
            }else{
                $(this).addClass('active');
                $('.index-page .technologies .show-hide').slideDown();
                $('.index-page .technologies .show-more .btn').html('<span>View Less <i class="bi bi-arrow-up ms-2 "></i></span>');
            }
        })
